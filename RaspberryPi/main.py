...
def main(args):
    ...
    try:
        # Create the serial object for communication between arduino and
        # computer. If the device is not found, an exception will be thrown.
        # An alias must be created to make the program work out of the box.
        # Read wiki section "Getting started" to understand how:
        # https://github.com/littlebrat/Hexapod/wiki/Getting-Started
        ser = Serial('/dev/arduino', baud_rate, timeout=2)
